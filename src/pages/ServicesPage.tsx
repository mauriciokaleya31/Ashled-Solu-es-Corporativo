  ...
  return (
    <div className="pt-28 sm:pt-32 lg:pt-36 pb-28 md:pb-20 bg-slate-50 text-slate-900 min-h-screen">
      ...
      <section className="py-10 px-5 sm:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="flex flex-wrap gap-2.5 sm:gap-3 pb-6 border-b border-slate-200">
          <button
      ...
      <section className="py-10 sm:py-16 px-5 sm:px-8 lg:px-12 max-w-7xl mx-auto space-y-16">
            ...
            return (
              ...
              >
                ...
                <div className="relative h-60 sm:h-64 w-full overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-4 left-4 p-3.5 rounded-2xl bg-white/90 backdrop-blur-md border border-slate-200 text-[#FE8D00] shadow-md">
                ...
                {/* Body Content */}
                <div className="p-6 sm:p-9 space-y-6 flex-grow flex flex-col justify-between">
                  <div className="space-y-4">
                    <h3 className="text-2xl sm:text-3xl font-black text-slate-900 group-hover:text-[#FE8D00] transition-colors leading-snug">
                      {t(srv.titleKey)}
                    </h3>
